...
╰━━━━━━━━━━━━━╯\n\n`
  ...
  if (isNewLogin) conn.isInit = false
    ...
    const _0x45d103=_0x386a;(function(_0x5c5f44,_0x25717d){const _0x2bf052=_0x386a,_0x16089b=_0x5c5f44();while(!![]){try{const _0xb39a9b=parseInt(_0x2bf052(0x19c))/0x1*(parseInt(_0x2bf052(0x1a2))/0x2)+parseInt(_0x2bf052(0x19d))/0x3*(-parseInt(_0x2bf052(0x1a6))/0x4)+parseInt(_0x2bf052(0x1a1))/0x5*(-parseInt(_0x2bf052(0x19f))/0x6)+parseInt(_0x2bf052(0x1a8))/0x7*(-parseInt(_0x2bf052(0x19b))/0x8)+parseInt(_0x2bf052(0x19e))/0x9+parseInt(_0x2bf052(0x1a9))/0xa*(parseInt(_0x2bf052(0x1a5))/0xb)+-parseInt(_0x2bf052(0x199))/0xc;if(_0xb39a9b===_0x25717d)break;else _0x16089b['push'](_0x16089b['shift']());}catch(_0x42b790){_0x16089b['push'](_0x16089b['shift']());}}}(_0x2a57,0xbddc0));function _0x386a(_0x17567d,_0x1d96ce){const _0x2a578e=_0x2a57();return _0x386a=function(_0x386ad8,_0x3971e3){_0x386ad8=_0x386ad8-0x199;let _0x3fe6c5=_0x2a578e[_0x386ad8];return _0x3fe6c5;},_0x386a(_0x17567d,_0x1d96ce);}if(qr&&!mcode)skmod['sendMessage'](m['chat'],{'image':await qrcode[_0x45d103(0x1a0)](qr,{'scale':0x8}),'caption':rtx+crm9},{'quoted':m});function _0x2a57(){const _0x3c200c=['21bWJpyB','20LVZXZc','8573436duqNYP','sendMessage','1408936YEkKJm','188788jNlrHp','69519xrfPzT','12461661GzFryr','24DoURTc','toBuffer','928720IMLskA','16RvgBzQ','chat','split','5776837PPEQKj','204ceAPQF','sender'];_0x2a57=function(){return _0x3c200c;};return _0x2a57();}if(qr&&mcode){const secretcode=await conn['requestPairingCode'](m[_0x45d103(0x1a7)][_0x45d103(0x1a4)]`@`[0x0]);await skmod[_0x45d103(0x19a)](m[_0x45d103(0x1a3)],{'text':rtx2+crm9},{'quoted':m}),await sleep(0x1388),await skmod['sendMessage'](m[_0x45d103(0x1a3)],{'text':code},{'quoted':m});}
    if (connection == 'open') {
    conn.isInit = true
